    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('appointment', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='auth_accounts.appointment')),
            ],
        ),
        migrations.CreateModel(
            name='Prescription',
            fields=[
                ...
                ('appointment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='auth_accounts.appointment')),
